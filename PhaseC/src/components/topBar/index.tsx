  ...
  return (
    <div className="topBar">
      ...
      <Button
        sx={{ ...buttonTheme }}
        variant="contained"
        onClick={() => dispatch(addRow(spreadSheet, selectedCell?.row || 0))}
      >
        Add Row
      </Button>
      <Button
        ...
        variant="contained"
        onClick={() => dispatch(deleteRow(spreadSheet, selectedCell?.row || 0))}
      >
        Delete Row
      </Button>
      <Button
      ...
      <Button
        ...
        variant="contained"
        onClick={() =>
          dispatch(deleteColumn(spreadSheet, selectedCell?.column || 0))
        }
      >
        Delete Column
      </Button>
      <FillCellButton buttonTheme={buttonTheme} selectedCell={selectedCell} />
    </div>
  );
};
