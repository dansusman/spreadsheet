...
describe("Grid Tests", () => {
    ...
    it("add column to top of grid", () => {
        ...
        expect(addColumn(gridState, 0).payload.grid).to.deep.equal(
            expectedGrid
        );
    ...
    it("add column to end of grid", () => {
        ...
        expect(addColumn(gridState, 1).payload.grid).to.deep.equal(
            expectedGrid
        );
    ...
    it("deleting row at top of grid", () => {
        ...
        expect(deleteRow(gridState, 0).payload.grid).to.deep.equal(
            expectedGrid
        );
    ...
    it("deleting row at end of grid", () => {
        ...
        expect(deleteRow(gridState, 1).payload.grid).to.deep.equal(
            expectedGrid
        );
    ...
    it("deleting column at top of grid", () => {
        ...
        expect(deleteColumn(gridState, 0).payload.grid).to.deep.equal(
            expectedGrid
        );
    ...
    it("deleting column at end of grid", () => {
        ...
        expect(deleteColumn(gridState, 1).payload.grid).to.deep.equal(
            expectedGrid
        );
    ...
    it("filling a cell red", () => {
        ...
        expect(fillCell(gridState, "RED", 0, 0).payload.grid).to.deep.equal(
            expectedGrid
        );
    ...
    it("filling a cell orange", () => {
        ...
        expect(fillCell(gridState, "ORANGE", 0, 0).payload.grid).to.deep.equal(
            expectedGrid
        );
    ...
    it("filling a cell yellow", () => {
        ...
        expect(fillCell(gridState, "YELLOW", 0, 0).payload.grid).to.deep.equal(
            expectedGrid
        );
    ...
    it("filling a cell light green", () => {
        ...
        expect(
            fillCell(gridState, "LIGHTGREEN", 0, 0).payload.grid
        ).to.deep.equal(expectedGrid);
    ...
    it("filling a cell light blue", () => {
        ...
        expect(
            fillCell(gridState, "LIGHTBLUE", 0, 0).payload.grid
        ).to.deep.equal(expectedGrid);
    ...
    it("filling a cell light purple", () => {
        ...
        expect(fillCell(gridState, "PURPLE", 0, 0).payload.grid).to.deep.equal(
            expectedGrid
        );
